    ...
    <body>
        ...
        <div class="flex-box">
            <div class="left">
                ...
                <div class="image">
                    <div class="small-img">
                        <img src="${detail.imageURL}" onclick="showImage(this.src)">
                    </div>
                    <div class="small-img">
                        <img src="images/away/${detail.code}_away.png" onclick="showImage(this.src)">
                    </div>
                    <div class="small-img">
                        <img src="images/away/${detail.code}_third.png" onclick="showImage(this.src)">
                    </div> 
                </div>
            </div>
            ...
            <div class="right">
                ...
                <div class="price">${detail.price} VND</div>
                <div class="size">
                    <p>Size: </p>
            ...
            <a href="products.jsp"><button class="return-btn">Return</button></a>
        </div>
