...
<html>
    ...
    <body>
        ...
        <div class="flex-box">
            <div class="left">
                <div class="big-img">
                    <img src="images/rma_home.png">
                </div>
                <div class="image">
                    <div class="small-img">
                        <img src="images/rma_home.png" onclick="showImage(this.src)">
                    </div>
                    <div class="small-img">
                        <img src="images/away/rma_away.png" onclick="showImage(this.src)">
                    </div>
                    <div class="small-img">
                        <img src="images/away/rma_third.png" onclick="showImage(this.src)">
                    </div> 
                </div>
            </div>
