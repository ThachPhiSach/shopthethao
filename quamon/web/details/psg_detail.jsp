...
<html>
    ...
    <body>
        ...
        <div class="flex-box">
            <div class="left">
                <div class="big-img">
                    <img src="images/psg_home.png">
                </div>
                <div class="image">
                    <div class="small-img">
                        <img src="images/psg_home.png" onclick="showImage(this.src)">
                    </div>
                    <div class="small-img">
                        <img src="images/away/psg_away.png" onclick="showImage(this.src)">
                    </div>
                    <div class="small-img">
                        <img src="images/away/psg_third.png" onclick="showImage(this.src)">
                    </div> 
                </div>
            </div>
