...
<html>
    ...
    <body>
        ...
        <div class="flex-box">
            <div class="left">
                <div class="big-img">
                    <img src="images/mci_home.png">
                </div>
                <div class="image">
                    <div class="small-img">
                        <img src="images/mci_home.png" onclick="showImage(this.src)">
                    </div>
                    <div class="small-img">
                        <img src="images/away/mci_away.png" onclick="showImage(this.src)">
                    </div>
                    <div class="small-img">
                        <img src="images/away/mci_third.png" onclick="showImage(this.src)">
                    </div> 
                </div>
            </div>
