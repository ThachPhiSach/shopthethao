...
<html>
    ...
    <body>
        ...
        <div class="flex-box">
            <div class="left">
                <div class="big-img">
                    <img src="images/liv_home.png">
                </div>
                <div class="image">
                    <div class="small-img">
                        <img src="images/liv_home.png" onclick="showImage(this.src)">
                    </div>
                    <div class="small-img">
                        <img src="images/away/liv_away.png" onclick="showImage(this.src)">
                    </div>
                    <div class="small-img">
                        <img src="images/away/liv_third.png" onclick="showImage(this.src)">
                    </div> 
                </div>
            </div>
